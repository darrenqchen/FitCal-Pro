...
-- Stores
INSERT INTO
    Stores (name, rating, country, city, zip, street)
VALUES
    (
        'Stop & Shop',
        8.3,
...
-- Ingredients
INSERT INTO
    Ingredients (price, quantity, calories, name, isVegan)
VALUES
    (6.45, 10, 100, 'sugar', 1);
...
VALUES
    (
        '1. wash vegetable  2. chop them  3. mix them with dressing',
        10,
        20,
        'none',
        'salad',
...
-- MealTrackers
INSERT INTO
    MealTrackers (mealDateTime, dayTrackerID)
VALUES
    (NOW(), 1);
...
-- DayTrackers
INSERT INTO
    DayTrackers (date, username)
VALUES
    ('2023-11-26', 'darrenchen');
...
-- WorkoutTrackers
INSERT INTO
    WorkoutTrackers (timeDuration, caloriesBurnt, dayTrackerID)
VALUES
    ('2:12:01', 100, 1);
...
-- Routines
INSERT INTO
    Routines (name, difficulty, timeDuration)
VALUES
    ('Push Pull Legs', 7, '2:12:01');

INSERT INTO
    Routines (name, difficulty, timeDuration)
VALUES
    ('Ab Circuit', 5, '6:13:02');
...
VALUES
    ('chest press', 50, 5, 7, 'dumbbell', 'chest');
...
VALUES
    ('deadlift', 315, 2, 9, 'barbell', 'chest');
